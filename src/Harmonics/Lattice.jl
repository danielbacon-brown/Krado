...
# Lattice(L₁, L₂, G₁, G₂; originOffset = _2VectorFloat(0.0,0.0) ) = Lattice( _2VectorFloat(L₁), _2VectorFloat(L₂), _2VectorFloat(G₁), _2VectorFloat(G₂); originOffset=_2VectorFloat(originOffset) )
# TODO:: improve how these get converted.
...
# function Lattice(L₁::_2VectorFloat, L₂::_2VectorFloat; originOffsetUV = _2VectorFloat(0.0,0.0)  )
    ...
    # return Lattice(L₁,L₂,G₁,G₂; originOffset=originOffset)
end
# Lattice(L₁, L₂; originOffsetUV = [], originOffsetXY = [] ) = Lattice(_2VectorFloat(L₁), _2VectorFloat(L₂); originOffsetUV=originOffsetUV, originOffsetXY=originOffsetXY)
# Lattice(L₁::TU2VectorReal, L₂::TU2VectorReal; originOffset = _2VectorFloat(0.0,0.0) ) = Lattice(_2VectorFloat(L₁), _2VectorFloat(L₂); originOffset=originOffset)
...
# calcReciprocals(L₁, L₂) = calcReciprocals(_2VectorFloat(L₁), _2VectorFloat(L₂))
...
# calcReciprocals(L) = calcReciprocals(_2VectorFloat(L))
...
# Lattice(L₁; originOffsetUV = [], originOffsetXY = []) = Lattice(_2VectorFloat(L₁); originOffsetUV=originOffsetUV, originOffsetXY=originOffsetXY)
...
# Returns the x,y coordinates of the lattice offset
# function getLatticeXYoffset(lattice::Lattice)
#     return lattice.originOffset[U]*lattice.L₁ + lattice.originOffset[V]*lattice.L₂
# end
